...
### Color scale
See `tokens/primitive/colors.tokens.json` for the full blue scale (50-900). The scale moves from near-white (#EBF0FF) to near-black (#041133), with 500 being the canonical brand color.
...
Dark mode palette: see `tokens/semantic/theme-dark.tokens.json`.
